...
export const metadata: Metadata = {
  title: "Organic Roots | The Premium Grocery Experience",
  description: "Discover a curated collection of artisanal organic produce, sourced directly from heritage farms.",
};
